...
| see-to-believe-lab (`/to_see_html`) | **Active — approved capability** | Standalone local visual verification tool at `D:\MyPrograming\tools\see-to-believe-lab`; Cursor skill `/to_see_html`; sessions under `sessions/<slug>/`; not Nodeme/Loyer; ops doc: _KnowledgeWiki `tools/see-to-believe-lab-to-see-html.md` | _KnowledgeWiki `tools/see-to-believe-lab-to-see-html.md` |

...
| see-to-believe-lab (`/to_see_html`) | **Active — approved capability (dual-mode closeout)** | Standalone local visual verification at `D:\MyPrograming\tools\see-to-believe-lab`; Cursor skill `/to_see_html`; **single-page** (default, small UI) + **split-view** (full pages — `preview.html`/`control.html`, live sync); external browser default; Nodeme full-page mockup proved split-view; not Nodeme/Loyer; marker `TO_SEE_HTML_CLOSEOUT_COMPLETE`; ops: _KnowledgeWiki `tools/see-to-believe-lab-to-see-html.md` | _KnowledgeWiki `tools/see-to-believe-lab-to-see-html.md` |
